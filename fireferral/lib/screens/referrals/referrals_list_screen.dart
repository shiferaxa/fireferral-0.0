  ...
  Future<void> _loadReferrals() async {
    ...
    try {
      ...
      if (user.role == UserRole.admin) {
        referrals = await _referralService.getAllReferrals(user.organizationId);
      } else {
        // Both associates and affiliates see only their own referrals
        referrals = await _referralService.getReferralsByUser(user.id, user.organizationId);
      }
